    ...
    public void CreateAcc() throws InterruptedException {
        ...
        for (String windowHandel : allWindows){
            if (!windowHandel.equals(mainWindowHandel)){
                ...
                createAccountPage.setFirstNameField("Sowmya");
                createAccountPage.setLastNameField("Bala");
                ...
                createAccountPage.setMobileNumberField("8056139345");
                Thread.sleep(2000);
                createAccountPage.setEmailField("Sowmya123@gmail.com");
                createAccountPage.setCPasswordField("Sowmya12345");
                createAccountPage.setNewPasswordField("Sowmya12345");
